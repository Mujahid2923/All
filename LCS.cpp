***************************mid exam**********************
			...
			var x = prompt( "how many users ? " ) ;
			while( x -- )
			{
				var a = prompt( "Enter your name" ) ;
				var b = prompt( "Enter your birth year" ) ;
				var c = 2020 - b ;
				document.write( "Age of " + a + " is " + c + "<br>" ) ;
			}
			...
			area = new Area( 2 , 2 ) ;
			console.log( "Volume" , area.cal().toFixed(4) ) ;
			...
			function randomImg() 
			{
	     	...
	     	console.log( '<img src=" '+ arr[ rnd ].src +' " />' ) ;
	   		}
			...
			function insert()
			{
				var val = document.getElementById('sample').insertRow( 0 ) ;
